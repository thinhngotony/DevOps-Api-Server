    ...
    class SimpleORM
    {
        ...
        public int save(int id = 0)
        {
            ...
            if (this.Properties.Count > 0)
            {
                ...
                return this.db.NonQuery(sql, this.internProperties.ToArray());
            }
        ...
        public int delete(int id = 0)
        {
            if (id > 0)
            {
                ...
                return this.db.NonQuery(sql, new string[] { "pk", id.ToString() });
            }
        ...
        public int create()
        {
            ...
            if (this.Properties.Count > 0)
            {
                ...
                int result = this.db.NonQuery(sql, this.internProperties.ToArray());
        ...
        {
            return this.db.GetDataOfTable(this.table);
        }
